...
public class ByteStreams_Class {
	...
	void fileOperation2() throws Exception {
		...
		FileOutputStream fos = new FileOutputStream("C:\\Users\\ADMIN\\OneDrive\\Desktop\\java\\Nit\\file2.txt", true); // append
																														// mood
		System.out.println("connection Created\n");
	...
	void fileOperation3() throws Exception {
		...
		FileInputStream fis = new FileInputStream(
				"C:\\\\Users\\\\ADMIN\\\\OneDrive\\\\Desktop\\\\java\\\\Nit\\\\file2.txt");
		FileOutputStream fos = new FileOutputStream(
				"C:\\\\Users\\\\ADMIN\\\\OneDrive\\\\Desktop\\\\java\\\\Nit\\\\file3.txt", true);
		System.out.println("Connection Created");
		int i;
		while ((i = fis.read()) != -1) {
			fos.write(i);
	...
	public static void main(String[] args) throws Exception {
		ByteStreams_Class aobj = new ByteStreams_Class();
		aobj.fileOperation1();
		aobj.fileOperation2();
		aobj.fileOperation3();
	}
