...
public class ClassAR {
	...
	void meth3() {
		...
		int i = 1;
		for (; i <= 5;)
			// int x=10 //C.E because we are cant write any declarative statement int this
			// line
			System.out.println("i value :" + i);
		i++;
	...
	void meth6() {
		...
		int i = 1;
		for (System.out.println("-----meth6"), System.out.println("-----"); i <= 3; System.out
				.println(new ClassAR().meth7())) {
			System.out.println("i value :" + i++);
		}
